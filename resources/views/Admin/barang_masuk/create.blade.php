...
<div class="max-w-3xl mx-auto mt-10 bg-white shadow-lg rounded-xl p-8 text-black">
    ...
    <form action="{{ route('admin.barangmasuk.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="jumlah" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500" required>
        </div>

        <div class="mb-6">
            <label class="block text-sm font-semibold mb-1">🏢 Supplier</label>
            <input type="text" name="keterangan" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500" required>
        </div>
